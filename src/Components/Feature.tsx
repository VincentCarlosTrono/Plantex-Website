...
const Feature = () => {
  ...
  return (
    <div className="grid-container">
      <div className="col-start-2 cols-end-3 flex justify-center items-center py-24 gap-10">
        <div>
          <img className="p-10" src={About} alt="aboutImg" />
        </div>

        <div>
          <h1 className="font-semibold text-5xl max-w-lg py-5">
            Who we really are & why choose us
          </h1>
          <p className="py-5 text-gray-600 max-w-sm">
          ...
          {details.map((detail: any) => {
            ...
            return (
              <div className="flex py-2">
                <p>{icon}</p>
                <p className="text-darkgreen font-semibold ">{description}</p>
              </div>
            );
          })}
          <button className="flex justify-center items-center p-7 text-darkgreen font-semibold ">
            Shop now
